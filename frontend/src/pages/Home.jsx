      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          <div className="inline-block bg-blue-100 rounded-full px-6 py-2 mb-6">
            <p className="text-blue-700 font-semibold">✨ About Sanjaya</p>
          </div>
          ...
          <p className="text-2xl text-gray-700 mb-12 max-w-4xl mx-auto leading-relaxed">
            Sanjaya is a daily emotional support program that helps children express their feelings through short, caring conversations with trained observers.
          </p>

          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-2 border-orange-200 rounded-3xl bg-gradient-to-br from-orange-50 to-orange-100 transform hover:scale-105 transition-all">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Daily Care</h3>
                <p className="text-gray-700 text-lg leading-relaxed">
                  5-minute daily check-ins give children a safe space to share their feelings without judgment.
                </p>
              </CardContent>
            </Card>

            <Card className="border-2 border-blue-200 rounded-3xl bg-gradient-to-br from-blue-50 to-blue-100 transform hover:scale-105 transition-all">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Trained Observers</h3>
                <p className="text-gray-700 text-lg leading-relaxed">
                  Caring adults trained in child psychology listen with empathy and notice patterns.
                </p>
              </CardContent>
            </Card>

            <Card className="border-2 border-green-200 rounded-3xl bg-gradient-to-br from-green-50 to-green-100 transform hover:scale-105 transition-all">
              <CardContent className="p-8 text-center">
                <div className="w-20 h-20 bg-gradient-to-br from-green-400 to-green-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                  <Sparkles className="w-10 h-10 text-white" />
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Parent Insights</h3>
                <p className="text-gray-700 text-lg leading-relaxed">
                  Parents receive thoughtful summaries to better understand and support their child's emotional world.
                </p>
              </CardContent>
            </Card>
          </div>
