        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            <div style="max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9f9f9;">
                ...
                <div style="background: white; padding: 20px; border-radius: 8px; margin: 20px 0;">
                    ...
                    <ul style="color: #666;">
                        <li><a href="https://youth-support-3.preview.emergentagent.com/about" style="color: #f97316;">Why Sanjaya Exists</a></li>
                        <li><a href="https://youth-support-3.preview.emergentagent.com/how-it-works" style="color: #f97316;">How It Works</a></li>
                        <li><a href="https://youth-support-3.preview.emergentagent.com/faq" style="color: #f97316;">Frequently Asked Questions</a></li>
                    </ul>
                </div>
